...
- (void)header
{
    ...
    headerView=[[UIView alloc] initWithFrame:CGRectMake(([UIScreen mainScreen].bounds.size.width - _scrollView.frame.size.width)/2 + 10, -headerHeight-10, _scrollView.frame.size.width, headerHeight)];
